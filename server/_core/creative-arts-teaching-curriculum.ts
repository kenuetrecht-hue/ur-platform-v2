...
const TAGLINES: Record<string, string> = {
  ...
  "ai-songwriter-001": "Learn songwriting — lyrics, hooks, chords, and finishing tracks.",
  "ai-logo-brand-001": "Learn brand design — logos, color, type, and full brand kits.",
  "ai-musician-001": "Learn to play instruments and write music — theory, practice, and performance.",
...
const SELF_PACED: Record<string, Record<LearningLevel, SelfPacedStep[]>> = {
  "ai-musician-001": {
    beginner: [
      { order: 1, title: "Pick your instrument", description: "Guitar, piano, drums, or voice — set up correctly.", estimatedMinutes: 15, moduleTitle: "How to practice effectively" },
      { order: 2, title: "Read your first notes", description: "Staff, note names, and quarter notes.", estimatedMinutes: 25, moduleTitle: "Reading music notation" },
      { order: 3, title: "Clap & count rhythms", description: "Metronome at 60 BPM.", estimatedMinutes: 20, moduleTitle: "Rhythm & timing" },
      { order: 4, title: "Play a one-octave scale", description: "Hands or fingers — slow and even.", estimatedMinutes: 30, moduleTitle: "Scales & keys" },
      { order: 5, title: "Learn three chords", description: "Play a simple song progression.", estimatedMinutes: 40, moduleTitle: "Chords on your instrument" },
    ],
    intermediate: [
      { order: 1, title: "Genre chord patterns", description: "I–V–vi–IV and variations.", estimatedMinutes: 35, moduleTitle: "Chords on your instrument" },
      { order: 2, title: "Ear training drills", description: "Identify intervals daily.", estimatedMinutes: 25, moduleTitle: "Ear training" },
      { order: 3, title: "Write an 8-bar melody", description: "Record or notate your idea.", estimatedMinutes: 45, moduleTitle: "Writing music on your instrument" },
    ],
    advanced: [
