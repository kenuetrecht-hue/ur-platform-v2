...
async function handlePrecheck(req: Request, res: Response): Promise<void> {
  try {
    ...
    res.status(502).json({
      verified: false,
      rejectionReason: "The picture check did not finish. Tap Check my three pictures again.",
      passToken: null,
      error: "The picture check did not finish. Tap Check my three pictures again.",
    });
  }
}
