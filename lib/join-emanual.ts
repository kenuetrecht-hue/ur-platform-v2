...
export const JOIN_EMANUAL_STEPS: JoinEmanualStep[] = [
  {
    ...
    clicks: [
      ...
      "You land on Login (https://urplatform.llc/login). That is the front door.",
  ...
  },
  {
    ...
    clicks: [
      "You are already on Login — or go to https://urplatform.llc/login.",
      "If you already joined, type only your email and password, then tap Login. You go into the app. You do not take the pictures again.",
      "If you are new, tap Sign up. That opens https://urplatform.llc/signup — name, email, password, then Continue to ID pictures.",
      ...
      "Then continue to the ID pictures page, then the selfie page. After they pass, we log you in.",
  ...
  },
  {
    ...
    clicks: [
      "The ID pictures are on the next Sign up page, then the selfie is on the page after that — you do not go to Age verify.",
      "Photograph your ID front and ID back, then a live selfie as each page asks. This keeps fraud off the site and locks your creator name so your content stays yours.",
  ...
  },
  {
    ...
    clicks: [
      ...
      "If that screen does not save it, tap Open PDF file, then Share → Save to Files or Downloads.",
      "On a phone, pick Save to Files or Downloads. Check Files or Downloads if you do not see it right away.",
