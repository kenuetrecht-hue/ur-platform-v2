...
export const JOIN_EMANUAL_STEPS: JoinEmanualStep[] = [
  ...
  },
  {
    ...
    clicks: [
      ...
      "If you are new, tap Sign up. That opens https://urplatform.llc/signup — name, email, password, then the three pictures.",
      ...
      "Then take the three pictures on that same page. After they pass, we log you in.",
  ...
  },
  {
    ...
    clicks: [
      "The three pictures are on the Sign up page — you do not go to a second Age verify page first.",
