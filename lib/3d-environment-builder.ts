...
export const AI3DModels: Record<string, AI3DModel> = {
  ...
  funding_ai: {
    ...
    category: "business",
    avatar: "💰",
    color: { r: 0.2, g: 0.55, b: 0.28 },
    uniform: "Funding AI",
    tools: ["capital_stack", "grant_map", "loan_readiness"],
    workspace: "boardroom",
    description: "Helps founders find grants, loans, and startup capital",
  },
  master_cnc_ai: {
    ...
    avatar: "🔩",
    color: { r: 0.45, g: 0.48, b: 0.52 },
    uniform: "Master CNC & Mill AI",
    tools: ["lathe", "mill", "drill", "nbc_cell", "gcode"],
    workspace: "machine_shop",
    description: "Lathes, mills, drills, and CNC setup",
  },
  culinary_arts_ai: {
    id: "ai-culinary-001",
    ...
    category: "culinary",
    avatar: "🍳",
    color: { r: 0.85, g: 0.35, b: 0.18 },
    uniform: "Culinary Arts AI",
    tools: ["knife", "range", "mixer", "thermometer", "recipe"],
    workspace: "kitchen",
    description: "Kitchen craft, food safety, and on-the-line coaching",
  },
  business_advisor: {
    id: "business_advisor",
