...
export const PAYMENT_CHANNEL_POLICY_SUMMARY =
  ...
  "subscription (day, week, month), $1 talk packs, the $120 / 500-minute and $200 / 1,000-minute packs, and Cartoon Studio (Draft, Lite, Mid, Cinema, Premiere) — must be purchased through your web browser.";
