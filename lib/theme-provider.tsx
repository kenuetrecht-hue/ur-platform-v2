...
import { LETTERING_ON_COLOR, LETTERING_ON_WHITE, applyDefaultLettering } from "@/lib/gold-lettering";
...
function applyCssColorVars(scheme: ColorScheme) {
  const ink = scheme === "light" ? LETTERING_ON_WHITE : LETTERING_ON_COLOR;
  applyDefaultLettering(ink);
    ...
    <ThemeContext.Provider value={value}>
      <View
        style={
          {
            flex: 1,
            color: colorScheme === "light" ? LETTERING_ON_WHITE : LETTERING_ON_COLOR,
          } as object
        }
      >
        {children}
