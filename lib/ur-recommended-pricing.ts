...
export const UR_RECOMMENDED_PRICING: RecommendedProductPricing[] = [
  {
    id: "text-standard",
    category: "Text chat",
    feature: "Standard specialist (ContentMate, social, legal ref, etc.)",
    prices: {
    ...
    notes: "Checkout default for standard-tier specialists.",
  },
  {
    id: "text-professional",
    category: "Text chat",
    feature: "Professional (TechBuilder, GameForge, CAD, blueprint, robotics)",
    prices: {
      day: { usd: 9.99, cap: "25 messages / 24h" },
      week: { usd: 19.99, cap: "90 messages / 7d" },
      month: { usd: 29.99, cap: "200 messages (~7/day)" },
      other: "Sandbox runs billed separately (see Code & sandbox)",
    },
    notes: "Higher token cost ~$0.015/msg.",
  },
  {
    id: "text-premium",
    category: "Text chat",
    feature: "Premium (LinguaMate, AI Translator)",
    prices: {
      day: { usd: 8.99, cap: "28 messages / 24h" },
      week: { usd: 17.99, cap: "100 messages / 7d" },
      month: { usd: 27.99, cap: "220 messages (~7/day)" },
    },
    notes: "Translation / language API premium.",
  },
  {
    id: "text-bundle-all",
    category: "Text chat",
    feature: "All specialists bundle (platform pass)",
    prices: {
      day: { usd: 15.99, cap: "1 active specialist / 24h" },
      week: { usd: 32.99, cap: "2 active specialists / 7d" },
      month: { usd: 64.99, cap: "3 active specialists / day" },
      other: "Switching AIs counts toward daily active limit",
    },
    notes: "Platform-wide bundle.",
  },
  {
    id: "voice-talk",
  ...
  },
  {
    id: "loyalty-text",
    category: "Loyalty",
    feature: "Free text via loyalty points",
    prices: {
      day: { usd: 0, cap: "500 LP per message" },
      week: { usd: 0, cap: "Daily sign-in 50 LP · Welcome 1000 LP" },
      month: { usd: 0, cap: "Streak milestones: free msgs day 5/10/20/30" },
      other: "No USD — points economy only",
    },
    notes: "Caps prevent API abuse.",
  },
];
