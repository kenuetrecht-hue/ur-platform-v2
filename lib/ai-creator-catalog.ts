...
export const AI_CREATOR_CATALOG: AiCreatorCatalogEntry[] = [
  ...
  { id: "ai-blockchain-001", name: "ChainSmith", avatar: "⛓️", category: "Technology", mission: "Teach and build blockchains — lessons, working chain code, and smart-contract labs." },
  ...
  { id: "ai-math-001", name: "Math Mentor AI", avatar: "∑", category: "Education", mission: "Teach mathematics — numbers through calculus, proofs, and shop-floor applied math. Not bookkeeping." },
  { id: "ai-reading-001", name: "Reading AI", avatar: "📖", category: "Language", mission: "Teach people to read — systematic phonics, decodable text, and other writing systems. Complements LinguaMate speaking." },
