...
export const UR_WORLD_PLAN_STATUS = {
  now: "Civic Plaza talk city — Plan A look (stone walkways, tables and chairs, sit/stand bar, fountain), blue/purple night plaza, garden, UR Sheriff owner avatar, three desks that start existing Talk, locker packs, buy-then-gift unused.",
...
export const UR_WORLD_PLAN_PHASES = [
  {
    ...
    ships: [
      ...
      "No public tip jar. UR does not ask members for tips or coffee money.",
