...
export default function CreateScreen() {
  ...
  const subMenu = consolidatedNavigation.getSubMenu("create");
    ...
    <ScreenContainer className="flex-1 bg-background">
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="px-4 py-6">
          <Text className="text-3xl font-bold text-foreground mb-2">Create</Text>
              ...
              >
                <View className="flex-row items-center gap-3 flex-1">
                  <View className="w-12 h-12 rounded-lg bg-primary/10 items-center justify-center">
                    <IconSymbol
                      name={item.icon as any || "pencil.circle.fill"}
                      size={24}
